...
const Event = memo(function EventComponent(props) {
  const ref = useRef();
...
function Main() {
  ...
  const onSize = size => sizesRef.current = [...sizesRef.current, size];
          ...
          <div className="hero-dashboard__primary">
            ...
            <ul className="hero-dashboard__info">
              <li className="hero-dashboard__item">
                ...
                <div className="hero-dashboard__item-details">+23<span className="a11y-hidden">°</span></div>
              </li>
              <li className="hero-dashboard__item">
                ...
                <div className="hero-dashboard__item-details">
                  ...
                  <div className="hero-dashboard__icon hero-dashboard__icon_rain" role="img" aria-label="Дождь" />
                </div>
              </li>
            </ul>
          </div>
      ...
      <section className="section main__devices">
        <div className="section__title">
          ...
          <select className="section__select" defaultValue="all" onInput={onSelectInput}>
            {TABS_KEYS.map(key => <option key={key} value={key}>{TABS[key].title}</option>)}
          </select>
